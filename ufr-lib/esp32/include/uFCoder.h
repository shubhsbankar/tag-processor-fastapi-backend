 ...
 *                      "UNIT_OPEN_RESET_ONLY"    : do only reader reset on opening. 
...
/**
 * @brief If one of the devices opened by ReaderList_UpdateAndGetCount() has been closed in the meantime
 * with the ReaderCloseM()
 * Use this method to re-open the device, based on the device serial number.
 * 
 * @param Device_SN 
 * @param hndUFR 
 * @return UFR_STATUS 
